...
(
    ...
    `type`       varchar(16)      not null default '' comment '类型：cut=CUT；styling=STYLING；spa=SPA；treatment=TREATMENT；hair_color=HAIR COLOR；perm=PERM；straight_perm=STRAIGHT PERM',
